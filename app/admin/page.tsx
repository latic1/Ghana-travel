...
import { MapPin, Building2, Users, Calendar, Star, TrendingUp } from 'lucide-react'
          ...
          <CardContent className="space-y-3">
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-600">Oceanview Resort Accra - 2 hours ago</p>
              </div>
            </div>
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
              <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
              <div className="flex-1">
                <p className="text-sm font-medium">Destination updated</p>
                <p className="text-xs text-gray-600">Cape Coast Castle - 5 hours ago</p>
              </div>
            </div>
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-600">Kakum National Park - 1 day ago</p>
              </div>
            </div>
          </CardContent>
        </Card>
